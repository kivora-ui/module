...
Los paquetes están en desarrollo (`0.0.0`). Las instrucciones de consumo npm se encuentran en cada README; para probar el código actual utiliza el workspace y sus ejemplos.
