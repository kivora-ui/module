...
**React Native Community CLI 0.87.1:** consulta la [integración con npm](docs/native-installation.md), las dependencias necesarias y el [informe de validación](docs/native-release-validation.md). Native e Init 0.2.1 están preparados como candidatos pendientes de publicación; Native 0.1.1 contiene dependencias `workspace:*` no instalables con npm.
