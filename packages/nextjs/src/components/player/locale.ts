const en = {
  ...
  live: 'Live', goLive: 'Go live', loading: 'Loading', splash: 'Opening video', ad: 'Advertisement', skipAd: 'Skip ad',
...
const es: PlayerMessages = {
  ...
  live: 'En directo', goLive: 'Ir al directo', loading: 'Cargando', splash: 'V\u00eddeo de inicio', ad: 'Anuncio', skipAd: 'Saltar anuncio',
