...
Indicador de carga breve para operaciones en curso.
...
```tsx
import { Spinner } from "@kivora/native";
```
...
- **Componentes y helpers visuales:** `Spinner`
- **Tipos de props:** `SpinnerProps`
- **Tipos relacionados:** —
...
- **Definido en:** `packages/nextjs/src/components/spinner.tsx`
...
| --- | --- | --- | --- |
| `label` | `string | undefined` | sí | — |
| `size` | `"sm" | "lg" | "md" | undefined` | sí | — |
| `variant` | `"default" | "destructive" | "primary" | "muted" | undefined` | sí | — |

<details>
<summary>Props heredadas o compuestas de `SpinnerProps` (278)</summary>
...
- **Definido en:** `packages/native/src/components/spinner.tsx`
- **Composición base:** `ActivityIndicatorProps`
...
<details>
<summary>Props heredadas o compuestas de `SpinnerProps` (120)</summary>
...
| `animating` | `boolean | undefined` | sí | Whether to show the indicator (`true`) or hide it (`false`). | `node_modules/.pnpm/react-native@0.87.1_@babel+core@7_d6nkc5uxvkoft4blgp3l52moe4/node_modules/react-native/types_generated/Libraries/Components/ActivityIndicator/ActivityIndicator.d.ts` |
...
| `color` | `____ColorValue_Internal | undefined` | sí | The foreground color of the spinner. | `node_modules/.pnpm/react-native@0.87.1_@babel+core@7_d6nkc5uxvkoft4blgp3l52moe4/node_modules/react-native/types_generated/Libraries/Components/ActivityIndicator/ActivityIndicator.d.ts` |
...
| `hidesWhenStopped` | `boolean | undefined` | sí | Whether the indicator should hide when not animating. | `node_modules/.pnpm/react-native@0.87.1_@babel+core@7_d6nkc5uxvkoft4blgp3l52moe4/node_modules/react-native/types_generated/Libraries/Components/ActivityIndicator/ActivityIndicator.d.ts` |
...
| `size` | `IndicatorSize | undefined` | sí | Size of the indicator. Small has a height of 20, large has a height of 36. | `node_modules/.pnpm/react-native@0.87.1_@babel+core@7_d6nkc5uxvkoft4blgp3l52moe4/node_modules/react-native/types_generated/Libraries/Components/ActivityIndicator/ActivityIndicator.d.ts` |
