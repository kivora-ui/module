...
Casilla de verificación controlada o no controlada para estados booleanos.
...
```tsx
import { Checkbox } from "@kivora/native";
```
...
- **Componentes y helpers visuales:** `Checkbox`
- **Tipos de props:** `CheckboxProps`
- **Tipos relacionados:** —
...
- **Definido en:** `packages/nextjs/src/components/checkbox.tsx`
- **Composición base:** `React.ComponentPropsWithoutRef<typeof CheckboxPrimitive.Root>`
...
<details>
<summary>Props heredadas o compuestas de `CheckboxProps` (293)</summary>
...
| `checked` | `CheckedState | undefined` | sí | — | `node_modules/.pnpm/@radix-ui+react-checkbox@1.3.11_@_k5kkqn7vlel3uhnjvyenh7xhba/node_modules/@radix-ui/react-checkbox/dist/index.d.mts` |
...
| `defaultChecked` | `CheckedState | undefined` | sí | — | `node_modules/.pnpm/@radix-ui+react-checkbox@1.3.11_@_k5kkqn7vlel3uhnjvyenh7xhba/node_modules/@radix-ui/react-checkbox/dist/index.d.mts` |
...
| `onCheckedChange` | `((checked: CheckedState) => void) | undefined` | sí | — | `node_modules/.pnpm/@radix-ui+react-checkbox@1.3.11_@_k5kkqn7vlel3uhnjvyenh7xhba/node_modules/@radix-ui/react-checkbox/dist/index.d.mts` |
...
| `required` | `boolean | undefined` | sí | — | `node_modules/.pnpm/@radix-ui+react-checkbox@1.3.11_@_k5kkqn7vlel3uhnjvyenh7xhba/node_modules/@radix-ui/react-checkbox/dist/index.d.mts` |
...
- **Definido en:** `packages/native/src/components/checkbox.tsx`
...
| --- | --- | --- | --- |
| `checked` | `boolean | undefined` | sí | — |
| `containerClassName` | `string | undefined` | sí | — |
| `defaultChecked` | `boolean | undefined` | sí | — |
| `label` | `string | undefined` | sí | Makes the label and indicator one accessible, pressable control. |
| `labelClassName` | `string | undefined` | sí | — |
| `onCheckedChange` | `((checked: boolean) => void) | undefined` | sí | — |

<details>
<summary>Props heredadas o compuestas de `CheckboxProps` (131)</summary>
