...
```tsx
import { Toggle, toggleVariants } from "@kivora/nextjs";
```

### @kivora/native

```tsx
import { Toggle } from "@kivora/native";
```
...
- **Componentes y helpers visuales:** `Toggle`, `toggleVariants`
- **Tipos de props:** `ToggleProps`
- **Tipos relacionados:** —

### Native

- **Componentes y helpers visuales:** `Toggle`
- **Tipos de props:** `ToggleProps`
- **Tipos relacionados:** —
...
export function Example() {
  return <Toggle>Ejemplo básico</Toggle>;
}
```
...
- **Definido en:** `packages/nextjs/src/components/toggle.tsx`
- **Composición base:** `Omit<React.ComponentPropsWithoutRef<typeof TogglePrimitive.Root>, "children"> & VariantProps<typeof toggleVariants>`

**Props propias**

| Prop | Tipo | Opcional | Descripción |
| --- | --- | --- | --- |
| `children` | `React.ReactNode | ((pressed: boolean) => React.ReactNode)` | sí | Static content or a function that renders content for the current pressed state. |

<details>
<summary>Props heredadas o compuestas de `ToggleProps` (294)</summary>
...
| `defaultPressed` | `boolean | undefined` | sí | The state of the toggle when initially rendered. Use `defaultPressed` if you do not need to control the state of the toggle. | `node_modules/.pnpm/@radix-ui+react-toggle@1.1.18_@ty_qe5536f3onescw5neh3y6hh3ni/node_modules/@radix-ui/react-toggle/dist/index.d.mts` |
...
| `onPressedChange` | `((pressed: boolean) => void) | undefined` | sí | The callback that fires when the state of the toggle changes. | `node_modules/.pnpm/@radix-ui+react-toggle@1.1.18_@ty_qe5536f3onescw5neh3y6hh3ni/node_modules/@radix-ui/react-toggle/dist/index.d.mts` |
...
| `pressed` | `boolean | undefined` | sí | The controlled state of the toggle. | `node_modules/.pnpm/@radix-ui+react-toggle@1.1.18_@ty_qe5536f3onescw5neh3y6hh3ni/node_modules/@radix-ui/react-toggle/dist/index.d.mts` |
...
- **Definido en:** `packages/native/src/components/toggle.tsx`
- **Composición base:** `Omit<PressableProps, "children">`

**Props propias**

| Prop | Tipo | Opcional | Descripción |
| --- | --- | --- | --- |
| `children` | `React.ReactNode | ((pressed: boolean) => React.ReactNode)` | sí | — |
| `defaultPressed` | `boolean | undefined` | sí | — |
| `onPressedChange` | `((pressed: boolean) => void) | undefined` | sí | — |
| `pressed` | `boolean | undefined` | sí | — |
| `size` | `"default" | "sm" | "lg" | "icon" | undefined` | sí | — |
| `variant` | `"default" | "outline" | "ghost" | undefined` | sí | — |

<details>
<summary>Props heredadas o compuestas de `ToggleProps` (131)</summary>
