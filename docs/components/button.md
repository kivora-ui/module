...
Botón principal del sistema con variantes visuales y tamaños compartidos.
...
- **Componentes y helpers visuales:** `Button`
- **Tipos de props:** `ButtonProps`
- **Tipos relacionados:** —
...
- **Definido en:** `packages/nextjs/src/components/button.tsx`
...
<details>
<summary>Props heredadas o compuestas de `ButtonProps` (284)</summary>
...
| `size` | `ButtonSize | null | undefined` | sí | — | `packages/nextjs/src/components/button.tsx` |
...
| `variant` | `ButtonVariant | null | undefined` | sí | — | `packages/nextjs/src/components/button.tsx` |
...
- **Definido en:** `packages/native/src/components/button.tsx`
- **Composición base:** `Omit<PressableProps, "children"> & VariantProps<typeof buttonVariants>`

**Props propias**

| Prop | Tipo | Opcional | Descripción |
| --- | --- | --- | --- |
| `accessibilityLabel` | `string | undefined` | sí | Overrides the text that's read by the screen reader when the user interacts with the element. By default, the label is constructed by traversing all the children and accumulating all the `Text` nodes separated by space. See https://reactnative.dev/docs/view#accessibilitylabel |
...
<details>
<summary>Props heredadas o compuestas de `ButtonProps` (132)</summary>
...
| `size` | `ButtonSize | null | undefined` | sí | — | `packages/native/src/components/button.tsx` |
...
| `variant` | `ButtonVariant | null | undefined` | sí | — | `packages/native/src/components/button.tsx` |
