...
Etiqueta compacta para estados, categorías o contadores breves.
...
```tsx
import { Badge } from "@kivora/native";
```
...
- **Componentes y helpers visuales:** `Badge`
- **Tipos de props:** `BadgeProps`
- **Tipos relacionados:** —
...
export function Example() {
  return <Badge>Ejemplo básico</Badge>;
}
```
...
- **Definido en:** `packages/nextjs/src/components/badge.tsx`
- **Composición base:** `React.HTMLAttributes<HTMLDivElement> & VariantProps<typeof badgeVariants>`
...
<details>
<summary>Props heredadas o compuestas de `BadgeProps` (279)</summary>
...
| `variant` | `BadgeVariant | null | undefined` | sí | — | `packages/nextjs/src/components/badge.tsx` |
...
- **Definido en:** `packages/native/src/components/badge.tsx`
- **Composición base:** `TextProps & VariantProps<typeof badgeVariants>`
...
<details>
<summary>Props heredadas o compuestas de `BadgeProps` (75)</summary>
...
| `variant` | `BadgeVariant | null | undefined` | sí | — | `packages/native/src/components/badge.tsx` |
