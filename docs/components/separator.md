...
Separador horizontal o vertical para dividir contenido relacionado.
...
```tsx
import { Separator } from "@kivora/native";
```
...
- **Componentes y helpers visuales:** `Separator`
- **Tipos de props:** `SeparatorProps`
- **Tipos relacionados:** —
...
- **Definido en:** `packages/nextjs/src/components/separator.tsx`
- **Composición base:** `React.ComponentPropsWithoutRef<typeof SeparatorPrimitive.Root>`
...
<details>
<summary>Props heredadas o compuestas de `SeparatorProps` (282)</summary>
...
| `decorative` | `boolean | undefined` | sí | Whether or not the component is purely decorative. When true, accessibility-related attributes are updated so that that the rendered element is removed from the accessibility tree. | `node_modules/.pnpm/@radix-ui+react-separator@1.1.15__ekyhpdzluja2guoeqxz3hoinou/node_modules/@radix-ui/react-separator/dist/index.d.mts` |
...
| `orientation` | `"horizontal" | "vertical" | undefined` | sí | Either `vertical` or `horizontal`. Defaults to `horizontal`. | `node_modules/.pnpm/@radix-ui+react-separator@1.1.15__ekyhpdzluja2guoeqxz3hoinou/node_modules/@radix-ui/react-separator/dist/index.d.mts` |
...
- **Definido en:** `packages/native/src/components/separator.tsx`
...
| --- | --- | --- | --- |
| `decorative` | `boolean | undefined` | sí | — |
| `orientation` | `"horizontal" | "vertical" | undefined` | sí | — |

<details>
<summary>Props heredadas o compuestas de `SeparatorProps` (116)</summary>
