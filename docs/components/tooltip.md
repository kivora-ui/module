...
Ayuda contextual breve anclada a un elemento.
...
```tsx
import { Tooltip, TooltipContent, TooltipProvider, TooltipTrigger } from "@kivora/nextjs";
```

### @kivora/native

```tsx
import { Tooltip, TooltipContent, TooltipProvider, TooltipTrigger } from "@kivora/native";
```
...
- **Componentes y helpers visuales:** `Tooltip`, `TooltipContent`, `TooltipProvider`, `TooltipTrigger`
- **Tipos de props:** `TooltipContentProps`
- **Tipos relacionados:** —

### Native

- **Componentes y helpers visuales:** `Tooltip`, `TooltipContent`, `TooltipProvider`, `TooltipTrigger`
- **Tipos de props:** `TooltipContentProps`, `TooltipProps`, `TooltipProviderProps`, `TooltipTriggerProps`
- **Tipos relacionados:** —
...
```tsx
import { Button, Tooltip, TooltipContent, TooltipProvider, TooltipTrigger } from "@kivora/nextjs";
...
```tsx
import { Button, Tooltip, TooltipContent, TooltipProvider, TooltipTrigger } from "@kivora/native";
...
- **Definido en:** `packages/nextjs/src/components/tooltip.tsx`
- **Composición base:** `React.ComponentPropsWithoutRef<typeof TooltipPrimitive.Content>`

**Props propias**

| Prop | Tipo | Opcional | Descripción |
| --- | --- | --- | --- |
| `showArrow` | `boolean | undefined` | sí | — |
| `size` | `"sm" | "lg" | "md" | undefined` | sí | — |
| `variant` | `"default" | "destructive" | "secondary" | undefined` | sí | — |

<details>
<summary>Props heredadas o compuestas de `TooltipContentProps` (294)</summary>
...
| `aria-label` | `string | undefined` | sí | A more descriptive label for accessibility purpose | `node_modules/.pnpm/@radix-ui+react-tooltip@1.2.16_@t_rmpnf6bu4gouszzstys4tvxhbm/node_modules/@radix-ui/react-tooltip/dist/index.d.mts` |
...
| `forceMount` | `true | undefined` | sí | Used to force mounting when more control is needed. Useful when controlling animation with React animation libraries. | `node_modules/.pnpm/@radix-ui+react-tooltip@1.2.16_@t_rmpnf6bu4gouszzstys4tvxhbm/node_modules/@radix-ui/react-tooltip/dist/index.d.mts` |
...
| `onEscapeKeyDown` | `((event: KeyboardEvent) => void) | undefined` | sí | Event handler called when the escape key is down. Can be prevented. | `node_modules/.pnpm/@radix-ui+react-tooltip@1.2.16_@t_rmpnf6bu4gouszzstys4tvxhbm/node_modules/@radix-ui/react-tooltip/dist/index.d.mts` |
...
| `onPointerDownOutside` | `((event: PointerDownOutsideEvent) => void) | undefined` | sí | Event handler called when the a `pointerdown` event happens outside of the `Tooltip`. Can be prevented. | `node_modules/.pnpm/@radix-ui+react-tooltip@1.2.16_@t_rmpnf6bu4gouszzstys4tvxhbm/node_modules/@radix-ui/react-tooltip/dist/index.d.mts` |
...
- **Definido en:** `packages/native/src/components/tooltip.tsx`
- **Composición base:** `TextProps & Pick<PopoverContentProps,
...
<details>
<summary>Props heredadas o compuestas de `TooltipContentProps` (79)</summary>
...
| `align` | `PopoverAlign | undefined` | sí | — | `packages/native/src/components/popover.tsx` |
| `alignOffset` | `number | undefined` | sí | — | `packages/native/src/components/popover.tsx` |
...
| `avoidCollisions` | `boolean | undefined` | sí | — | `packages/native/src/components/popover.tsx` |
...
| `collisionPadding` | `number | undefined` | sí | — | `packages/native/src/components/popover.tsx` |
...
| `side` | `PopoverSide | undefined` | sí | — | `packages/native/src/components/popover.tsx` |
| `sideOffset` | `number | undefined` | sí | — | `packages/native/src/components/popover.tsx` |
...
| --- | --- | --- | --- |
| `children` | `string | number | bigint | boolean | React.ReactElement<unknown, string | React.JSXElementConstructor<any>> | Iterable<React.ReactNode> | React.ReactPortal | Promise<AwaitedReactNode> | null | undefined` | sí | — |
| `defaultOpen` | `boolean | undefined` | sí | — |
| `onOpenChange` | `((open: boolean) => void) | undefined` | sí | — |
| `open` | `boolean | undefined` | sí | — |
...
<details>
<summary>Props heredadas o compuestas de `TooltipTriggerProps` (131)</summary>
