...
Barra de progreso lineal para cargas, procesos y porcentajes.
...
```tsx
import { Progress } from "@kivora/native";
```
...
- **Componentes y helpers visuales:** `Progress`
- **Tipos de props:** `ProgressProps`
- **Tipos relacionados:** `ProgressSize`
...
- **Definido en:** `packages/nextjs/src/components/progress.tsx`
- **Composición base:** `React.ComponentPropsWithoutRef<typeof ProgressPrimitive.Root>`

**Props propias**

| Prop | Tipo | Opcional | Descripción |
| --- | --- | --- | --- |
| `indicatorClassName` | `string | undefined` | sí | — |
| `size` | `ProgressSize | undefined` | sí | — |

<details>
<summary>Props heredadas o compuestas de `ProgressProps` (283)</summary>
...
| `getValueLabel` | `((value: number, max: number) => string) | undefined` | sí | — | `node_modules/.pnpm/@radix-ui+react-progress@1.1.16_@_5fygonebfiv55s3vkxuecc62xa/node_modules/@radix-ui/react-progress/dist/index.d.mts` |
...
| `max` | `number | undefined` | sí | — | `node_modules/.pnpm/@radix-ui+react-progress@1.1.16_@_5fygonebfiv55s3vkxuecc62xa/node_modules/@radix-ui/react-progress/dist/index.d.mts` |
...
| `value` | `number | null | undefined` | sí | — | `node_modules/.pnpm/@radix-ui+react-progress@1.1.16_@_5fygonebfiv55s3vkxuecc62xa/node_modules/@radix-ui/react-progress/dist/index.d.mts` |
...
- **Definido en:** `packages/native/src/components/progress.tsx`
...
| `size` | `ProgressSize | undefined` | sí | — |
| `value` | `number | null | undefined` | sí | — |

<details>
<summary>Props heredadas o compuestas de `ProgressProps` (116)</summary>
