...
Tarjeta informativa web que se abre al pasar o enfocar un trigger.
...
```tsx
import { HoverCard, HoverCardContent, HoverCardTrigger } from "@kivora/nextjs";
```
...
- **Componentes y helpers visuales:** `HoverCard`, `HoverCardContent`, `HoverCardTrigger`
- **Tipos de props:** `HoverCardContentProps`, `HoverCardProps`
- **Tipos relacionados:** —
...
```tsx
import { HoverCard } from "@kivora/nextjs";

export function Example() {
  return <HoverCard>Ejemplo básico</HoverCard>;
}
```
...
- **Definido en:** `packages/nextjs/src/components/hover-card.tsx`
- **Composición base:** `React.ComponentPropsWithoutRef<typeof HoverCardPrimitive.Content>`
...
<details>
<summary>Props heredadas o compuestas de `HoverCardContentProps` (296)</summary>
...
| `forceMount` | `true | undefined` | sí | Used to force mounting when more control is needed. Useful when controlling animation with React animation libraries. | `node_modules/.pnpm/@radix-ui+react-hover-card@1.1.23_wm4wrnpym4eigtrvj7h7h3jmdu/node_modules/@radix-ui/react-hover-card/dist/index.d.mts` |
...
| `onEscapeKeyDown` | `((event: KeyboardEvent) => void) | undefined` | sí | Event handler called when the escape key is down. Can be prevented. | `node_modules/.pnpm/@radix-ui+react-hover-card@1.1.23_wm4wrnpym4eigtrvj7h7h3jmdu/node_modules/@radix-ui/react-hover-card/dist/index.d.mts` |
...
| `onFocusOutside` | `((event: FocusOutsideEvent) => void) | undefined` | sí | Event handler called when the focus moves outside of the `HoverCard`. Can be prevented. | `node_modules/.pnpm/@radix-ui+react-hover-card@1.1.23_wm4wrnpym4eigtrvj7h7h3jmdu/node_modules/@radix-ui/react-hover-card/dist/index.d.mts` |
...
| `onInteractOutside` | `((event: PointerDownOutsideEvent | FocusOutsideEvent) => void) | undefined` | sí | Event handler called when an interaction happens outside the `HoverCard`. Specifically, when a `pointerdown` event happens outside or focus moves outside of it. Can be prevented. | `node_modules/.pnpm/@radix-ui+react-hover-card@1.1.23_wm4wrnpym4eigtrvj7h7h3jmdu/node_modules/@radix-ui/react-hover-card/dist/index.d.mts` |
...
| `onPointerDownOutside` | `((event: PointerDownOutsideEvent) => void) | undefined` | sí | Event handler called when the a `pointerdown` event happens outside of the `HoverCard`. Can be prevented. | `node_modules/.pnpm/@radix-ui+react-hover-card@1.1.23_wm4wrnpym4eigtrvj7h7h3jmdu/node_modules/@radix-ui/react-hover-card/dist/index.d.mts` |
...
- **Definido en:** `packages/nextjs/src/components/hover-card.tsx`
- **Composición base:** `React.ComponentPropsWithoutRef<typeof HoverCardPrimitive.Root>`
...
<details>
<summary>Props heredadas o compuestas de `HoverCardProps` (6)</summary>
...
| `closeDelay` | `number | undefined` | sí | — | `node_modules/.pnpm/@radix-ui+react-hover-card@1.1.23_wm4wrnpym4eigtrvj7h7h3jmdu/node_modules/@radix-ui/react-hover-card/dist/index.d.mts` |
| `defaultOpen` | `boolean | undefined` | sí | — | `node_modules/.pnpm/@radix-ui+react-hover-card@1.1.23_wm4wrnpym4eigtrvj7h7h3jmdu/node_modules/@radix-ui/react-hover-card/dist/index.d.mts` |
| `onOpenChange` | `((open: boolean) => void) | undefined` | sí | — | `node_modules/.pnpm/@radix-ui+react-hover-card@1.1.23_wm4wrnpym4eigtrvj7h7h3jmdu/node_modules/@radix-ui/react-hover-card/dist/index.d.mts` |
| `open` | `boolean | undefined` | sí | — | `node_modules/.pnpm/@radix-ui+react-hover-card@1.1.23_wm4wrnpym4eigtrvj7h7h3jmdu/node_modules/@radix-ui/react-hover-card/dist/index.d.mts` |
| `openDelay` | `number | undefined` | sí | — | `node_modules/.pnpm/@radix-ui+react-hover-card@1.1.23_wm4wrnpym4eigtrvj7h7h3jmdu/node_modules/@radix-ui/react-hover-card/dist/index.d.mts` |
