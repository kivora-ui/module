...
Renderiza códigos de barras SVG a partir de los formatos soportados por `@kivora/codes`.
...
- **Componentes y helpers visuales:** `Barcode`
- **Tipos de props:** `BarcodeProps`
- **Tipos relacionados:** —
...
- **Definido en:** `packages/nextjs/src/components/barcode.tsx`
- **Composición base:** `Omit<React.HTMLAttributes<HTMLDivElement>, 'onError' | 'children'> & CodeOptions`

**Props propias**

| Prop | Tipo | Opcional | Descripción |
| --- | --- | --- | --- |
| `displayValue` | `boolean | undefined` | sí | — |
| `fallback` | `string | number | bigint | boolean | React.ReactElement<unknown, string | React.JSXElementConstructor<any>> | Iterable<React.ReactNode> | React.ReactPortal | Promise<AwaitedReactNode> | null | undefined` | sí | — |
| `height` | `number | undefined` | sí | — |
| `onError` | `((error: Error) => void) | undefined` | sí | — |
| `width` | `number | undefined` | sí | — |

<details>
<summary>Props heredadas o compuestas de `BarcodeProps` (282)</summary>
...
| `format` | `"qrcode" | "code128" | "code39" | "ean13" | "ean8" | "upca" | "interleaved2of5" | "datamatrix" | "pdf417" | "azteccode" | undefined` | sí | Defaults to code128. | `packages/codes/src/index.ts` |
...
- **Definido en:** `packages/native/src/components/barcode.tsx`
- **Composición base:** `Omit<ViewProps, 'children'> & CodeOptions`
...
<details>
<summary>Props heredadas o compuestas de `BarcodeProps` (121)</summary>
