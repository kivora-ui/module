...
Panel superpuesto desde un borde para formularios, detalles o navegación secundaria.
...
```tsx
import { Sheet, SheetClose, SheetContent, SheetDescription, SheetOverlay, SheetPortal, SheetTitle, SheetTrigger } from "@kivora/nextjs";
```

### @kivora/native

```tsx
import { Sheet, SheetClose, SheetContent, SheetDescription, SheetFooter, SheetHeader, SheetOverlay, SheetPortal, SheetTitle, SheetTrigger } from "@kivora/native";
```
...
- **Componentes y helpers visuales:** `Sheet`, `SheetClose`, `SheetContent`, `SheetDescription`, `SheetOverlay`, `SheetPortal`, `SheetTitle`, `SheetTrigger`
- **Tipos de props:** `SheetContentProps`, `SheetProps`
- **Tipos relacionados:** `SheetSide`

### Native

- **Componentes y helpers visuales:** `Sheet`, `SheetClose`, `SheetContent`, `SheetDescription`, `SheetFooter`, `SheetHeader`, `SheetOverlay`, `SheetPortal`, `SheetTitle`, `SheetTrigger`
- **Tipos de props:** `SheetContentProps`, `SheetProps`
- **Tipos relacionados:** `SheetSide`
...
```tsx
import { Sheet } from "@kivora/nextjs";

export function Example() {
  return <Sheet>Ejemplo básico</Sheet>;
}
```
...
```tsx
import { Sheet } from "@kivora/native";
...
- **Definido en:** `packages/nextjs/src/components/sheet.tsx`
...
| --- | --- | --- | --- |
| `closeLabel` | `string | undefined` | sí | — |
| `portalContainer` | `HTMLElement | null | undefined` | sí | — |
| `side` | `SheetSide | undefined` | sí | — |

<details>
<summary>Props heredadas o compuestas de `SheetContentProps` (288)</summary>
...
<details>
<summary>Props heredadas o compuestas de `SheetProps` (5)</summary>
...
- **Definido en:** `packages/native/src/components/sheet.tsx`
...
<details>
<summary>Props heredadas o compuestas de `SheetContentProps` (116)</summary>
