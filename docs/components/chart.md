...
Ayudantes para componer gráficas con tooltip y leyenda consistentes.
...
```tsx
import { ChartContainer, ChartLegend, ChartTooltip, ChartTooltipContent } from "@kivora/nextjs";
```

### @kivora/native

```tsx
import { ChartContainer, ChartLegend, ChartTooltip, ChartTooltipContent } from "@kivora/native";
```
...
- **Componentes y helpers visuales:** `ChartContainer`, `ChartLegend`, `ChartTooltip`, `ChartTooltipContent`
- **Tipos de props:** `ChartContainerProps`, `ChartTooltipContentProps`
- **Tipos relacionados:** `ChartConfig`

### Native

- **Componentes y helpers visuales:** `ChartContainer`, `ChartLegend`, `ChartTooltip`, `ChartTooltipContent`
- **Tipos de props:** `ChartContainerProps`, `ChartTooltipContentProps`
- **Tipos relacionados:** `ChartConfig`, `ChartDatum`
...
```tsx
import { ChartContainer } from "@kivora/nextjs";

export function Example() {
  return <ChartContainer>Ejemplo básico</ChartContainer>;
}
```
...
```tsx
import { ChartContainer } from "@kivora/native";
...
- **Definido en:** `packages/nextjs/src/components/chart.tsx`
...
| --- | --- | --- | --- |
| `config` | `ChartConfig | undefined` | sí | — |

<details>
<summary>Props heredadas o compuestas de `ChartContainerProps` (278)</summary>
...
| Prop | Tipo | Opcional | Descripción |
| --- | --- | --- | --- |
| `active` | `boolean | undefined` | sí | — |
| `formatter` | `((value: unknown, name: string) => React.ReactNode) | undefined` | sí | — |
| `label` | `string | number | bigint | boolean | React.ReactElement<unknown, string | React.JSXElementConstructor<any>> | Iterable<React.ReactNode> | React.ReactPortal | Promise<AwaitedReactNode> | null | undefined` | sí | — |
| `payload` | `{ color?: string; dataKey?: string | number; name?: string; value?: unknown; }[] | undefined` | sí | — |

<details>
<summary>Props heredadas o compuestas de `ChartTooltipContentProps` (278)</summary>
...
- **Definido en:** `packages/native/src/components/chart.tsx`
...
| Prop | Tipo | Opcional | Descripción |
| --- | --- | --- | --- |
| `config` | `{ [x: string]: { label?: string; color?: string; }; }` | no | — |
| `data` | `ChartDatum[] | undefined` | sí | — |
| `height` | `number | undefined` | sí | — |
| `onValueSelect` | `((value: ChartDatum) => void) | undefined` | sí | — |

<details>
<summary>Props heredadas o compuestas de `ChartContainerProps` (116)</summary>
...
| Prop | Tipo | Opcional | Descripción |
| --- | --- | --- | --- |
| `formatter` | `((value: number, label: string) => React.ReactNode) | undefined` | sí | — |

<details>
<summary>Props heredadas o compuestas de `ChartTooltipContentProps` (116)</summary>
