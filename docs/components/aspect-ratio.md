...
Contenedor que preserva una proporción fija al renderizar medios o bloques responsivos.
...
```tsx
import { AspectRatio } from "@kivora/native";
```
...
- **Componentes y helpers visuales:** `AspectRatio`
- **Tipos de props:** `AspectRatioProps`
- **Tipos relacionados:** —
...
export function Example() {
  return <AspectRatio>Ejemplo básico</AspectRatio>;
}
```
...
- **Definido en:** `packages/nextjs/src/components/aspect-ratio.tsx`
...
| `ratio` | `number | undefined` | sí | — |

<details>
<summary>Props heredadas o compuestas de `AspectRatioProps` (278)</summary>
...
- **Definido en:** `packages/native/src/components/aspect-ratio.tsx`
...
<details>
<summary>Props heredadas o compuestas de `AspectRatioProps` (116)</summary>
