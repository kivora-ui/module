...
Bloque de código formateado con soporte de tema y scroll.
...
```tsx
import { Code } from "@kivora/native";
```
...
- **Componentes y helpers visuales:** `Code`
- **Tipos de props:** `CodeProps`
- **Tipos relacionados:** `CodeTheme`
...
export function Example() {
  return <Code>Ejemplo básico</Code>;
}
```
...
- **Definido en:** `packages/nextjs/src/components/code.tsx`
- **Composición base:** `Omit<React.HTMLAttributes<HTMLDivElement>, "children">`
...
| --- | --- | --- | --- |
| `children` | `string` | no | — |
| `copyable` | `boolean | undefined` | sí | — |
| `filename` | `string | undefined` | sí | — |
| `inline` | `boolean | undefined` | sí | — |
| `language` | `string | undefined` | sí | — |
| `showLineNumbers` | `boolean | undefined` | sí | — |
| `theme` | `CodeTheme | undefined` | sí | — |
| `wrapLongLines` | `boolean | undefined` | sí | — |

<details>
<summary>Props heredadas o compuestas de `CodeProps` (277)</summary>
...
- **Definido en:** `packages/native/src/components/code.tsx`
...
| Prop | Tipo | Opcional | Descripción |
| --- | --- | --- | --- |
| `code` | `string | undefined` | sí | — |
| `language` | `string | undefined` | sí | — |
| `showLineNumbers` | `boolean | undefined` | sí | — |
| `theme` | `CodeTheme | undefined` | sí | — |

<details>
<summary>Props heredadas o compuestas de `CodeProps` (116)</summary>
