...
Panel deslizante web desde un borde para navegación o acciones secundarias.
...
```tsx
import { Drawer, DrawerClose, DrawerContent, DrawerDescription, DrawerOverlay, DrawerPortal, DrawerTitle, DrawerTrigger } from "@kivora/nextjs";
```

### @kivora/native

```tsx
import { Drawer, DrawerClose, DrawerContent, DrawerDescription, DrawerFooter, DrawerHeader, DrawerOverlay, DrawerPortal, DrawerTitle, DrawerTrigger } from "@kivora/native";
```
...
- **Componentes y helpers visuales:** `Drawer`, `DrawerClose`, `DrawerContent`, `DrawerDescription`, `DrawerOverlay`, `DrawerPortal`, `DrawerTitle`, `DrawerTrigger`
- **Tipos de props:** `DrawerContentProps`, `DrawerProps`
- **Tipos relacionados:** —

### Native

- **Componentes y helpers visuales:** `Drawer`, `DrawerClose`, `DrawerContent`, `DrawerDescription`, `DrawerFooter`, `DrawerHeader`, `DrawerOverlay`, `DrawerPortal`, `DrawerTitle`, `DrawerTrigger`
- **Tipos de props:** `DrawerContentProps`, `DrawerProps`
- **Tipos relacionados:** —
...
```tsx
import { Drawer } from "@kivora/nextjs";

export function Example() {
  return <Drawer>Ejemplo básico</Drawer>;
}
```
...
```tsx
import { Drawer } from "@kivora/native";
...
- **Definido en:** `packages/nextjs/src/components/drawer.tsx`
- **Composición base:** `React.ComponentPropsWithoutRef<typeof DialogPrimitive.Content>`

**Props propias**

| Prop | Tipo | Opcional | Descripción |
| --- | --- | --- | --- |
| `showHandle` | `boolean | undefined` | sí | — |

<details>
<summary>Props heredadas o compuestas de `DrawerContentProps` (288)</summary>
...
| `deferPointerDownOutside` | `boolean | undefined` | sí | When `true`, a `'pointerdown'` event outside of the layered element will wait for the interaction's click event before dispatching, allowing third-party code to stop propagation of later events and cancel dismissal. | `node_modules/.pnpm/@radix-ui+react-dismissable-layer_bm7xi7whqifwizcfkyj2t5mzq4/node_modules/@radix-ui/react-dismissable-layer/dist/index.d.mts` |
...
| `forceMount` | `true | undefined` | sí | Used to force mounting when more control is needed. Useful when controlling animation with React animation libraries. | `node_modules/.pnpm/@radix-ui+react-dialog@1.1.23_@ty_ddiphgnedt6gulnmvt3fbvbeeu/node_modules/@radix-ui/react-dialog/dist/index.d.mts` |
...
| `onCloseAutoFocus` | `((event: Event) => void) | undefined` | sí | Event handler called when auto-focusing on close. Can be prevented. | `node_modules/.pnpm/@radix-ui+react-dialog@1.1.23_@ty_ddiphgnedt6gulnmvt3fbvbeeu/node_modules/@radix-ui/react-dialog/dist/index.d.mts` |
...
| `onEscapeKeyDown` | `((event: KeyboardEvent) => void) | undefined` | sí | Event handler called when the escape key is down. Can be prevented. | `node_modules/.pnpm/@radix-ui+react-dismissable-layer_bm7xi7whqifwizcfkyj2t5mzq4/node_modules/@radix-ui/react-dismissable-layer/dist/index.d.mts` |
...
| `onFocusOutside` | `((event: FocusOutsideEvent) => void) | undefined` | sí | Event handler called when the focus moves outside of the `DismissableLayer`. Can be prevented. | `node_modules/.pnpm/@radix-ui+react-dismissable-layer_bm7xi7whqifwizcfkyj2t5mzq4/node_modules/@radix-ui/react-dismissable-layer/dist/index.d.mts` |
...
| `onInteractOutside` | `((event: PointerDownOutsideEvent | FocusOutsideEvent) => void) | undefined` | sí | Event handler called when an interaction happens outside the `DismissableLayer`. Specifically, when a `pointerdown` event happens outside or focus moves outside of it. Can be prevented. | `node_modules/.pnpm/@radix-ui+react-dismissable-layer_bm7xi7whqifwizcfkyj2t5mzq4/node_modules/@radix-ui/react-dismissable-layer/dist/index.d.mts` |
...
| `onOpenAutoFocus` | `((event: Event) => void) | undefined` | sí | Event handler called when auto-focusing on open. Can be prevented. | `node_modules/.pnpm/@radix-ui+react-dialog@1.1.23_@ty_ddiphgnedt6gulnmvt3fbvbeeu/node_modules/@radix-ui/react-dialog/dist/index.d.mts` |
...
| `onPointerDownOutside` | `((event: PointerDownOutsideEvent) => void) | undefined` | sí | Event handler called when the a `pointerdown` event happens outside of the `DismissableLayer`. Can be prevented. | `node_modules/.pnpm/@radix-ui+react-dismissable-layer_bm7xi7whqifwizcfkyj2t5mzq4/node_modules/@radix-ui/react-dismissable-layer/dist/index.d.mts` |
...
- **Definido en:** `packages/nextjs/src/components/drawer.tsx`
- **Composición base:** `React.ComponentPropsWithoutRef<typeof DialogPrimitive.Root>`
...
<details>
<summary>Props heredadas o compuestas de `DrawerProps` (5)</summary>

| Prop | Tipo | Opcional | Descripción | Origen |
| --- | --- | --- | --- | --- |
| `children` | `string | number | bigint | boolean | React.ReactElement<unknown, string | React.JSXElementConstructor<any>> | Iterable<React.ReactNode> | React.ReactPortal | Promise<AwaitedReactNode> | null | undefined` | sí | — | `node_modules/.pnpm/@radix-ui+react-dialog@1.1.23_@ty_ddiphgnedt6gulnmvt3fbvbeeu/node_modules/@radix-ui/react-dialog/dist/index.d.mts` |
...
- **Definido en:** `packages/native/src/components/drawer.tsx`
...
<details>
<summary>Props heredadas o compuestas de `DrawerContentProps` (117)</summary>
...
| `side` | `SheetSide | undefined` | sí | — | `packages/native/src/components/sheet.tsx` |
...
<details>
<summary>Props heredadas o compuestas de `DrawerProps` (4)</summary>

| Prop | Tipo | Opcional | Descripción | Origen |
| --- | --- | --- | --- | --- |
| `children` | `string | number | bigint | boolean | React.ReactElement<unknown, string | React.JSXElementConstructor<any>> | Iterable<React.ReactNode> | React.ReactPortal | Promise<AwaitedReactNode> | null | undefined` | sí | — | `packages/native/src/components/sheet.tsx` |
| `defaultOpen` | `boolean | undefined` | sí | — | `packages/native/src/components/sheet.tsx` |
| `onOpenChange` | `((open: boolean) => void) | undefined` | sí | — | `packages/native/src/components/sheet.tsx` |
| `open` | `boolean | undefined` | sí | — | `packages/native/src/components/sheet.tsx` |
