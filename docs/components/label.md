...
Label accesible para asociar texto descriptivo a controles de formulario.
...
```tsx
import { Label } from "@kivora/native";
```
...
- **Componentes y helpers visuales:** `Label`
- **Tipos de props:** `LabelProps`
- **Tipos relacionados:** —
...
export function Example() {
  return <Label>Ejemplo básico</Label>;
}
```
...
- **Definido en:** `packages/nextjs/src/components/label.tsx`
- **Composición base:** `React.ComponentPropsWithoutRef<typeof LabelPrimitive.Root> & VariantProps<typeof labelVariants>`
...
<details>
<summary>Props heredadas o compuestas de `LabelProps` (282)</summary>
...
- **Definido en:** `packages/native/src/components/label.tsx`
...
<details>
<summary>Props heredadas o compuestas de `LabelProps` (74)</summary>
