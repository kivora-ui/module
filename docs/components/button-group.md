...
Agrupa botones relacionados y alinea acciones horizontales o verticales.
...
```tsx
import { ButtonGroup } from "@kivora/native";
```
...
- **Componentes y helpers visuales:** `ButtonGroup`
- **Tipos de props:** `ButtonGroupProps`
- **Tipos relacionados:** —
...
export function Example() {
  return <ButtonGroup>Ejemplo básico</ButtonGroup>;
}
```
...
- **Definido en:** `packages/nextjs/src/components/button-group.tsx`
...
<details>
<summary>Props heredadas o compuestas de `ButtonGroupProps` (278)</summary>
...
- **Definido en:** `packages/native/src/components/button-group.tsx`
...
<details>
<summary>Props heredadas o compuestas de `ButtonGroupProps` (116)</summary>
