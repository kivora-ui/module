...
Placeholder de carga para reservar espacio mientras llegan datos.
...
```tsx
import { Skeleton } from "@kivora/native";
```
...
- **Componentes y helpers visuales:** `Skeleton`
- **Tipos de props:** `SkeletonProps`
- **Tipos relacionados:** —
...
- **Definido en:** `packages/nextjs/src/components/skeleton.tsx`
...
| --- | --- | --- | --- |
| `animate` | `boolean | undefined` | sí | — |

<details>
<summary>Props heredadas o compuestas de `SkeletonProps` (278)</summary>
...
- **Definido en:** `packages/native/src/components/skeleton.tsx`
...
<details>
<summary>Props heredadas o compuestas de `SkeletonProps` (116)</summary>
