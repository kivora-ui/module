...
Cuestionario guiado por pasos o preguntas con navegación entre respuestas.
...
```tsx
import { Questionnaire } from "@kivora/native";
```
...
- **Componentes y helpers visuales:** `Questionnaire`
- **Tipos de props:** `QuestionnaireProps`
- **Tipos relacionados:** `QuestionnaireAnswer`, `QuestionnaireOption`, `QuestionnaireQuestion`, `QuestionnaireQuestionType`
...
export function Example() {
  return <Questionnaire>Ejemplo básico</Questionnaire>;
}
```
...
- **Definido en:** `packages/nextjs/src/components/questionnaire.tsx`
...
| --- | --- | --- | --- |
| `defaultAnswers` | `Record<string, QuestionnaireAnswer> | undefined` | sí | — |
| `onComplete` | `((answers: Record<string, QuestionnaireAnswer>) => void) | undefined` | sí | — |
| `questions` | `QuestionnaireQuestion[]` | no | — |

<details>
<summary>Props heredadas o compuestas de `QuestionnaireProps` (278)</summary>
...
- **Definido en:** `packages/native/src/components/questionnaire.tsx`
...
<details>
<summary>Props heredadas o compuestas de `QuestionnaireProps` (116)</summary>
